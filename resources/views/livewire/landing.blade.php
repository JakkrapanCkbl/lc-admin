	...
	<div class="container">
		<div class="row text-center justify-content-center">
			<div class="col-lg-8 ps-4">
				<h3 class="header-family">ประเภททรัพย์สินที่ประเมินมูลค่า</h3>
		...
		<div class="row">
			<div class="col-12 col-md-4 p-4 fanimate">
				...
				<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width=60 height=60 xmlns:xlink=" http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" style="" xml:space="preserve">
					<g>
						<path fill="#8FBD56" d="M165,0C74.019,0,0,74.019,0,165s74.019,165,165,165s165-74.019,165-165S255.981,0,165,0z M165,300
		c-74.44,0-135-60.561-135-135S90.56,30,165,30s135,60.561,135,135S239.439,300,165,300z" />
						<path fill="#8FBD56" d="M226.872,106.664l-84.854,84.853l-38.89-38.891c-5.857-5.857-15.355-5.858-21.213-0.001
		...
		C242.227,100.807,232.73,100.806,226.872,106.664z" />
			...
			<div class="col-12 col-md-4 p-4 fanimate">
				<div class="features-icon">
					<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
						<path fill="#8FBD56" opacity=".3" d="M8.44444,3.11121c-1.10457,0-2,0.89543-2,2v13.55556c-0.00003,1.22729-0.99493,2.22219-2.22222,2.22223h14.44445C20.50762,20.889,22,19.39662,22,17.55567c0,0,0-0.00001,0-0.00001V5.11121c0-1.10457-0.89543-2-2-2L8.44444,3.11121z" />
						<path fill="#8FBD56" d="M6.44446,18.66675V7.55603H4c-1.10455,0-2,0.89539-2,1.99994v9.33301c0,1.10461,0.89545,2,2,2h0.22223C5.44952,20.88898,6.4444,19.89404,6.44446,18.66675z" />
						<path fill="#8FBD56" d="M17,9.0001h-6c-0.55229,0-1-0.44771-1-1s0.44771-1,1-1h6c0.55228,0,1,0.44772,1,1S17.55228,9.0001,17,9.0001z M17,13.0001h-1c-0.55229,0-1-0.44771-1-1s0.44771-1,1-1h1c0.55228,0,1,0.44771,1,1S17.55228,13.0001,17,13.0001z M12,13.0001h-1c-0.55229,0-1-0.44771-1-1s0.44771-1,1-1h1c0.55229,0,1,0.44771,1,1S12.55229,13.0001,12,13.0001z M17,17.0001h-1c-0.55229,0-1-0.44772-1-1c0-0.55229,0.44771-1,1-1h1c0.55228,0,1,0.44771,1,1C18,16.55238,17.55228,17.0001,17,17.0001z M12,17.0001h-1c-0.55229,0-1-0.44772-1-1c0-0.55229,0.44771-1,1-1h1c0.55229,0,1,0.44771,1,1C13,16.55238,12.55229,17.0001,12,17.0001z" />
					</svg>
				</div>
				<h4 class="mx-1">
					Advanced Pages
			...
			<div class="col-12 col-md-4 p-4 fanimate">
				<div class="features-icon">
					<svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24">
						...
						<path fill="#8FBD56" d="M9 7H6A1 1 0 0 1 6 5H9A1 1 0 0 1 9 7zM9 13H6a1 1 0 0 1 0-2H9a1 1 0 0 1 0 2zM9 19H6a1 1 0 0 1 0-2H9a1 1 0 0 1 0 2z" />
					</svg>
				</div>
				<h4 class="mx-1">
			...
			<div class="col-12 col-md-4 p-4 fanimate">
				<div class="features-icon">
					<svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24">
						<path fill="#8FBD56" opacity=".3" d="M11,22A9,9,0,0,1,11,4a.99943.99943,0,0,1,1,1v7h7a.99943.99943,0,0,1,1,1A9.00984,9.00984,0,0,1,11,22Z" />
						<path fill="#8FBD56" d="M21,10H15a.99943.99943,0,0,1-1-1V3a.99943.99943,0,0,1,1-1,7.0018,7.0018,0,0,1,7,7A.99943.99943,0,0,1,21,10Z" />
					</svg>
				</div>
				<h4 class="mx-1">
					5 Types Of Charts
	...
	<div class="container">
		<div class="row justify-content-center text-center">
			<div class="col-lg-8 ps-4 mb-lg-0- mb-4">
				<h3 class="header-family">เกี่ยวกับบริษัทของเรา</h3>
				<p class="text-default sub-text mb-0"><b>บริษัท แลนด์มาร์ค คอนซัลแทนส์ จำกัด</b> ตั้งขึ้นจากการรวบรวมบุคคลากรที่มีประสบการณ์ และความเชี่ยวชาญในด้านการประเมินมูลค่าทรัพย์สินประเภทอสังหาริมทรัพย์ เครื่องจักรและอุปกรณ์ การวิเคราะห์ตลาด และการให้คำปรึกษาด้านธุรกิจอสังหาริมทรัพย์</p>
			</div>
		</div>
		<div class="row justify-content-center">
			<div class="col-lg-12">
					...
					<div class="slide">
						<div class="row align-items-center">
							...
							<div class="col-md-5 col-12">
								<img class="img-fluid float-md-end" src="{{asset('assets/images/landing/desktop.png')}}" alt="">
							</div>
						</div>
					</div>
					<div class="slide">
						<div class="row align-items-center">
							...
							<div class="col-md-5 col-sm-12">
								<img class="img-fluid float-md-end" src="{{asset('assets/images/landing/laptop.png')}}" alt="">
							</div>
						</div>
					</div>
					<div class="slide">
						<div class="row align-items-center">
							...
							<div class="col-md-5 col-sm-12">
								<img class="img-fluid float-md-end" src="{{asset('assets/images/landing/tablet.png')}}" alt="">
							</div>
						</div>
					</div>
					<div class="slide">
						<div class="row align-items-center">
							...
							<div class="col-md-5 col-sm-12">
								<img class="img-fluid float-md-end" src="{{asset('assets/images/landing/mobile.png')}}" alt="">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container">
		...
		<div class="row align-items-center">
			<div class="col-xl-5 customize-image text-center">
				<img class="img-fluid p-5" src="{{asset('assets/images/landing/customize.png')}}" alt="">
			</div>
...
<div class="bg-primary section bg-white" id="Clients">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-lg-12">
				<div class="customer-logos">
					<div class="slide"><img src="{{asset('assets/images/landing/companies/apple.png')}}" alt=""></div>
					<div class="slide"><img src="{{asset('assets/images/landing/companies/chrome.png')}}" alt=""></div>
					<div class="slide"><img src="{{asset('assets/images/landing/companies/google.png')}}" alt=""></div>
					<div class="slide"><img src="{{asset('assets/images/landing/companies/edge.png')}}" alt=""></div>
					<div class="slide"><img src="{{asset('assets/images/landing/companies/firefox.png')}}" alt=""></div>
					<div class="slide"><img src="{{asset('assets/images/landing/companies/opera.png')}}" alt=""></div>
					<div class="slide"><img src="{{asset('assets/images/landing/companies/safari.png')}}" alt=""></div>
					<div class="slide"><img src="{{asset('assets/images/landing/companies/bing.png')}}" alt=""></div>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="row d-flex align-items-center justify-content-center">
								<div class="col-lg-4 col-sm-8">
									<div class="card p-3 pricing-card">
										...
										<div class="card-body pt-2">
											<ul class="text-justify pricing-body ps-0">
												<li class="mb-4"><span class="text-warning me-2 p-1 bg-warning-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong> 2 Free</strong>
													Domain Name</li>
												<li class="mb-4"><span class="text-warning me-2 p-1 bg-warning-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong>3 </strong>
													One-Click Apps</li>
												<li class="mb-4 text-muted"><span class="text-gray me-2 p-1 bg-light-transparent rounded-pill text-10-f"><i class="fa fa-times"></i></span> <strong> 1 </strong>
													Databases</li>
												<li class="mb-4 text-muted"><span class="text-gray me-2 p-1 bg-light-transparent rounded-pill text-10-f"><i class="fa fa-times"></i></span> <strong> Unlimited </strong>
													Cloud Storage</li>
												<li class="mb-4 text-muted"><span class="text-gray me-2 p-1 bg-light-transparent rounded-pill text-10-f"><i class="fa fa-times"></i></span> <strong> Money </strong>
													BackGuarantee</li>
												<li class="mb-6 text-muted"><span class="text-gray me-2 p-1 bg-light-transparent rounded-pill text-10-f"><i class="fa fa-times"></i></span> <strong> 24/7</strong>
													support</li>
											</ul>
										</div>
								...
								<div class="col-lg-4 col-sm-8">
									<div class="card p-3 pricing-card">
										...
										<div class="card-body pt-2">
											<ul class="text-justify pricing-body ps-0">
												<li class="mb-4"><span class="text-info me-2 p-1 bg-info-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong> 1 Free</strong>
													Domain Name</li>
												<li class="mb-4"><span class="text-info me-2 p-1 bg-info-transparent  rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong>4 </strong>
													One-Click Apps</li>
												<li class="mb-4"><span class="text-info me-2 p-1 bg-info-transparent  rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong> 2 </strong>
													Databases</li>
												<li class="mb-4 text-muted"><span class="text-gray me-2 p-1 bg-light-transparent  rounded-pill text-10-f"><i class="fa fa-times"></i></span> <strong> Unlimited </strong>
													Cloud Storage</li>
												<li class="mb-4 text-muted"><span class="text-gray me-2 p-1 bg-light-transparent  rounded-pill text-10-f"><i class="fa fa-times"></i></span> <strong> Money </strong>
								...
								<div class="col-lg-4 col-sm-8">
									<div class="card p-3 border-primary pricing-card advanced">
										<div class="card-header d-block text-justified pt-2">
											<p class="text-18 font-weight-semibold mb-1 pe-0">Advanced<span class="float-end badge bg-primary text-white text-12-f pt-3">Limited
													Deal</span></p>
										...
										<div class="card-body pt-2">
											<ul class="text-justify pricing-body ps-0">
												<li class="mb-4"><span class="text-primary me-2 p-1 bg-primary-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong> 5 Free</strong>
													Domain Name</li>
												<li class="mb-4"><span class="text-primary me-2 p-1 bg-primary-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong>5 </strong>
													One-Click Apps</li>
												<li class="mb-4"><span class="text-primary me-2 p-1 bg-primary-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong> 3 </strong>
													Databases</li>
												<li class="mb-4"><span class="text-primary me-2 p-1 bg-primary-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong> Unlimited
													</strong> Cloud Storage</li>
												<li class="mb-4"><span class="text-primary me-2 p-1 bg-primary-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong> Money </strong>
													BackGuarantee</li>
												<li class="mb-6"><span class="text-primary me-2 p-1 bg-primary-transparent rounded-pill text-10-f"><i class="fa fa-check"></i></span> <strong> 24/7</strong>
													support</li>
											</ul>
										</div>
										<div class="card-footer text-center border-top-0 pt-1">
						...
						<div class="tab-pane" id="month">
							<div class="row d-flex align-items-center justify-content-center">
								...
								<div class="col-lg-4 col-sm-8">
									<div class="card p-3 border-primary pricing-card advanced">
										<div class="card-header d-block text-justified pt-2">
											<p class="text-18 font-weight-semibold mb-1 pe-0">Advanced<span class="float-end badge bg-primary text-white">Limited
													Deal</span></p>
	...
	<div class="container">
		...
		<div class="row text-center team">
			<div class="col-lg-3 col-sm-6 mb-5">
				<div class="bg-white shadow-sm p-5 team-card"><img src="{{asset('assets/images/landing/team/1.jpg')}}" alt="" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
			...
			<div class="col-lg-3 col-sm-6 mb-5">
				<div class="bg-white shadow-sm p-5 team-card"><img src="{{asset('assets/images/landing/team/2.jpg')}}" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
			...
			<div class="col-lg-3 col-sm-6 mb-5">
				<div class="bg-white shadow-sm p-5 team-card"><img src="{{asset('assets/images/landing/team/3.jpg')}}" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
			...
			<div class="col-lg-3 col-sm-6 mb-5">
				<div class="bg-white shadow-sm p-5 team-card"><img src="{{asset('assets/images/landing/team/4.jpg')}}" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
